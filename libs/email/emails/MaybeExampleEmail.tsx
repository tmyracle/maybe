                    ...
                    <Container className="border border-solid border-[#eaeaea] rounded my-[40px] mx-auto p-[20px] max-w-[465px]">
                        ...
                        <Section className="text-white mt-[32px] mb-[32px] text-center">
                            <Text className="text-lg">
                                <span className="mr-2">🏦</span> Connect your bank accounts
                            </Text>
                            <Text className="text-lg">
                                <span className="mr-2">🏡</span> Add your investments and assets
                            </Text>
                            <Text className="text-lg">
                                <span className="mr-2">📈</span> Set up your financial goals
                            </Text>
                        </Section>
